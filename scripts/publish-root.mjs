...
for (const file of ['generated/teleoperation.png', 'generated/interaction.png', 'brand/lingju-huijing-logo.svg', 'profile/chenyu-zhang.webp']) {
...
for (const item of ['assets', 'generated', 'brand', 'profile', 'index.html']) {
